...
*/
    public class VRDataIndex {
        ...
        public float[] GetValueAsFloatArray(string name) {
            return (float[])_hash[name];
        }
        ...
        public string DataToXML(string name) {
            ...
            if (valueType.IsArray) { // array type
                ...
                if (valueType == typeof(int)) {
                    ...
                    props.Add("type", "float");
                    fieldData = GetValueAsFloat(name).ToString();
                }
                else if (valueType == typeof(double)) {
        ...
        public VRDataIndex(String name) {
            _name = name;
            _hash = new Hashtable();
        }
